...
enum ParseChar
{
   ...
   TAB_KEY          = int('\t'),  // tab('\t') or ctrl-i     // 9
   NEWLINE_KEY      = int('\n'),  // enter('\n') or ctrl-m or ctrl-j   // 10
   ...
   //
   MOD_KEY_FLAG     = 1 << 9,  // 512
   MOD_KEY_INT      = 91,
   //HOME_KEY         = 49 + MOD_KEY_FLAG,
   HOME_KEY         = 16,                    // ctrl-p
   //INSERT_KEY       = 50 + MOD_KEY_FLAG,
   INSERT_KEY       = 14,                    // ctrl-n
   DELETE_KEY       = 51 + MOD_KEY_FLAG,     // fn-backspace
