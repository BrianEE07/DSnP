...
getChar(istream& istr)
{
   ...
   switch (ch) {
      ...
      case HOME_KEY:        // mine // Ctrl-p 
      case INSERT_KEY:      // mine // Ctrl-n 
      case END_KEY:         // mine // Ctrl-l 
      case PG_UP_KEY:       // mine // Ctrl-u 
      case PG_DOWN_KEY:     // mine // Ctrl-k 
         return returnCh(ch);
      ...
      case ESC_KEY: {
         ...
         if (combo == char(MOD_KEY_INT)) {
            ...
            if (key == char(DELETE_KEY)) {       // modified
